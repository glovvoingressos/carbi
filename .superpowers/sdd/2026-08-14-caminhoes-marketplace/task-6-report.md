...
- JSON-LD usa `serializeJsonLd`, neutralizando `<` antes de inserção no script e preservando JSON válido.
...
- `node --experimental-strip-types scripts/test-truck-seo.mjs`: PASS.
