    ...
    <main className="min-h-screen bg-[#f5f5f3] pb-16 pt-32">
      <div className="container mx-auto max-w-4xl px-4">
        <section className="bg-white rounded-[32px] border border-black/5 p-8 sm:p-12 shadow-sm">
          ...
          <h1 className="mt-2 text-4xl font-black text-[#0A0A0A] tracking-tight">Seu painel de perfil</h1>
          ...
          <div className="mt-10 grid gap-4 sm:grid-cols-2">
            <Link href="/minha-conta/anuncios" className="rounded-3xl bg-[#f5f5f3] border border-black/5 p-6 transition-all hover:-translate-y-1 hover:bg-[#0A0A0A] hover:text-white group">
            ...
            <Link href="/minha-conta/conversas" className="rounded-3xl bg-[#f5f5f3] border border-black/5 p-6 transition-all hover:-translate-y-1 hover:bg-[#0A0A0A] hover:text-white group">
              <div className="flex items-center gap-3 text-[#0A0A0A] group-hover:text-white transition-colors">
            ...
            <Link href="/anunciar-carro" className="rounded-3xl bg-[#f5f5f3] border border-black/5 p-6 transition-all hover:-translate-y-1 hover:bg-[#0A0A0A] hover:text-white group">
              <div className="flex items-center gap-3 text-[#0A0A0A] group-hover:text-white transition-colors">
            ...
            <Link href="/entrar" className="rounded-3xl bg-[#f5f5f3] border border-black/5 p-6 transition-all hover:-translate-y-1 hover:bg-[#0A0A0A] hover:text-white group">
              <div className="flex items-center gap-3 text-[#0A0A0A] group-hover:text-white transition-colors">
